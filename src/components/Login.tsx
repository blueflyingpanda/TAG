...
export default function Login() {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 shadow-xl max-w-md w-full mx-auto">
      <h1 className="text-3xl font-bold text-white mb-2 text-center">T.A.G.</h1>
      <p className="text-white/80 mb-8 text-center">Themed Alias Game</p>
