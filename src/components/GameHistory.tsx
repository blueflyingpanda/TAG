            ...
            <div>
              ...
              <div className="rounded-game border border-text/10 bg-text/[0.04] p-4">
                {selectedGame.info?.teams && selectedGame.info.teams.length > 0 ? (
                  ...
                  <div className="text-text/60">{t.gh_noTeams}</div>
                )}
              </div>
            </div>
  ...
  if (isLoading) {
    return (
      <div className="mx-auto w-full max-w-4xl rounded-game bg-card p-8 shadow-sm">
        <div className="text-center text-text/80">{t.gh_loading}</div>
      </div>
    );
  }
  ...
  return (
    <div className="mx-auto w-full max-w-4xl rounded-game bg-card p-6 shadow-sm md:p-8">
      <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
        <h1 className="text-3xl font-bold text-text">{t.gh_title}</h1>
        <button
          type="button"
          onClick={onBack}
          className="rounded-game border border-text/15 bg-text/[0.06] px-4 py-2 font-semibold text-text transition hover:bg-text/10"
      ...
      {games.length === 0 ? (
        <p className="py-8 text-center text-text/60">{t.gh_noGames}</p>
      ) : (
