  ...
  return (
    <div className="relative flex min-h-dvh flex-col items-center justify-center overflow-hidden bg-transparent p-2 md:p-4">
      ...
      <div className="relative mt-20 flex w-full flex-col items-center gap-4 md:mt-36 md:gap-6">
        ...
        {/* Action Buttons */}
        {!gameState.isPaused ? (
          <div className="relative mt-8 z-20 flex w-full max-w-[min(290px,calc(100vw-2rem))] flex-col gap-2 px-0 pb-[max(0.5rem,env(safe-area-inset-bottom))] md:gap-3 md:pb-0">
          ...
          <div className="relative mt-6 z-20 flex w-full justify-center pb-[max(0.5rem,env(safe-area-inset-bottom))] md:pb-0">
            <Button
              type="button"
              variant="success"
              onClick={resumeRound}
